        ...
        <div className="min-h-screen flex flex-col items-center justify-center px-4">
            ...
            <div className="text-center mb-10">
                ...
                <p className="text-slate-500 text-sm">
                    Start auditing your financial contracts in minutes.
                </p>
            </div>
            ...
            <div className="w-full max-w-sm">
                ...
                <button
                    ...
                    className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-slate-200 rounded-xl text-sm font-medium text-slate-700 hover:bg-slate-50 transition-colors cursor-pointer"
                >
                ...
                <div className="relative my-6">
                    ...
                    <div className="relative flex justify-center text-xs">
                        <span className="bg-[#FAFAF9] px-3 text-slate-400 uppercase tracking-wider">or</span>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        <label htmlFor="name" className="block text-xs font-medium text-slate-500 uppercase tracking-wider mb-1.5">
                            Full Name
                        </label>
                        <input
                            id="name"
