...
export function RiskScoreGauge({ score }: { score: number }) {
    ...
    return (
        <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm flex flex-col items-center select-none">
            <div className="flex justify-between items-center w-full mb-4">
                ...
                <div className="group relative">
                    ...
                    {/* Tooltip */}
                    <div className="absolute right-0 top-6 w-64 p-3 bg-slate-800 text-slate-50 text-xs rounded shadow-lg opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto transition-opacity z-10">
            ...
            <div className="flex justify-between w-full text-xs text-slate-400 px-6 font-medium mt-1">
                <span>0</span>
                <span>100</span>
            </div>
        </div>
